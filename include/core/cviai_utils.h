...
DLL_EXPORT CVI_S32 CVI_AI_StbReadImage(const char *filepath, VIDEO_FRAME_INFO_S *frame,
                                       PIXEL_FORMAT_E format);
...
DLL_EXPORT CVI_S32 CVI_AI_CreateImageFromVideoFrame(const VIDEO_FRAME_INFO_S *p_src_frame,
                                                    cvai_image_t *image);
DLL_EXPORT CVI_S32 CVI_AI_CreateImageFromVideoFrameSize(const VIDEO_FRAME_INFO_S *p_crop_frame,
