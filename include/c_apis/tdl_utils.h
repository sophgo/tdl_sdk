...
int32_t TDL_InitObjectMeta(TDLObject *object_meta,
                           int num_objects,
                           int num_landmark);

int32_t TDL_ReleaseObjectMeta(TDLObject *object_meta);

int32_t TDL_InitFaceMeta(TDLFace *face_meta,
                         int num_faces,
...
int32_t TDL_InitInstanceSegMeta(TDLInstanceSeg *inst_seg_meta,
                                int num_objects,
                                uint32_t mask_size);
