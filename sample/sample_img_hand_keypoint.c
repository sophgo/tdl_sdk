...
int main(int argc, char *argv[]) {
  if (argc != 5) {
    printf(
        "Usage: %s <hand detection model path> <hand keypoint model path> <hand keypoint classification model path> <input image path>\n", argv[0]);
    ...
    printf("hand keypoint classification model path: Path to hand keypoint classification model cvimodel.\n");
