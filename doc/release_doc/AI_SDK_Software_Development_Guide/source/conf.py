...
project = 'AISDKSoftwareDevelopmentGuide'
release = 'AISDKSoftwareDevelopmentGuide'
...
\begin{center}
    ...
    \graphicspath{{cvitek-develop-docs/CV180x_CV181x/zh/common/images/}}

    \includegraphics[width=0.8\textwidth]{logo.png}

    \vspace*{3cm}
    
    \Huge \textbf{AI SDK软件开发指南} \par
