...
// CVI_S32 _FaceCapture_Init(face_capture_t **face_cpt_info, uint32_t
// buffer_size);
...
// CVI_S32 _FaceCapture_SetConfig(face_capture_t *face_cpt_info,
...
// CVI_S32 _FaceCapture_SetMode(face_capture_t *face_cpt_info, capture_mode_e
// mode);
...
//                                      face_capture_t *face_cpt_info, int
//                                      data_idx);
