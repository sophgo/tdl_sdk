...
std::vector<anchor_box> generate_anchors(int base_size, const std::vector<float> &ratios,
                                         const std::vector<int> &scales, int stride, bool dense_anchor);
std::vector<std::vector<anchor_box> > generate_anchors_fpn(bool dense_anchor, const std::vector<anchor_cfg> &cfg);
