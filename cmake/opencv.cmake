...
if (SHRINK_OPENCV_SIZE)
  ...
  if ("${CMAKE_TOOLCHAIN_FILE}" MATCHES "toolchain-uclibc-linux.cmake")
    set(OPENCV_URL ftp://swftp:cvitek@10.58.65.3/sw_rls/cv1835/third_party/latest/uclibc/opencv_aisdk.tar.gz)
  elseif("${CMAKE_TOOLCHAIN_FILE}" MATCHES "toolchain-gnueabihf-linux.cmake")
    set(OPENCV_URL ftp://swftp:cvitek@10.58.65.3/sw_rls/cv1835/third_party/latest/32bit/opencv_aisdk.tar.gz)
  elseif("${CMAKE_TOOLCHAIN_FILE}" MATCHES "toolchain-aarch64-linux.cmake")
    set(OPENCV_URL ftp://swftp:cvitek@10.58.65.3/sw_rls/cv1835/third_party/latest/64bit/opencv_aisdk.tar.gz)
  else()
