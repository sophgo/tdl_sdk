...
elseif ("${CVI_PLATFORM}" STREQUAL "MARS" OR "${CVI_PLATFORM}" STREQUAL "MARS_PHOBOS")
  set(ISP_HEADER_PATH ${MIDDLEWARE_SDK_ROOT}/include/isp/mars/)
elseif ("${CVI_PLATFORM}" STREQUAL "PHOBOS")
...
if("${CVI_PLATFORM}" STREQUAL "MARS" OR "${CVI_PLATFORM}" STREQUAL "PHOBOS"  OR "${CVI_PLATFORM}" STREQUAL "MARS_PHOBOS")
