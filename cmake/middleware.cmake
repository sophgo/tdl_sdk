...
elseif ("${CVI_PLATFORM}" STREQUAL "MARS" OR "${CVI_PLATFORM}" STREQUAL "CV181X" )
  set(ISP_HEADER_PATH ${MIDDLEWARE_SDK_ROOT}/include/isp/mars/)
elseif ("${CVI_PLATFORM}" STREQUAL "PHOBOS" OR "${CVI_PLATFORM}" STREQUAL "CV180X")
...
if("${CVI_PLATFORM}" STREQUAL "MARS" OR "${CVI_PLATFORM}" STREQUAL "CV181X"  OR "${CVI_PLATFORM}" STREQUAL "PHOBOS"  OR "${CVI_PLATFORM}" STREQUAL "CV180X")
