...
if("${TRACER_SDK_ROOT}" STREQUAL "")
  message(FATAL_ERROR "You must set TRACER_SDK_ROOT before building IVE library.")
...
if (NOT "${CMAKE_BUILD_TYPE}" STREQUAL "SDKRelease")
  install(DIRECTORY ${TRACER_SDK_ROOT}/include/ DESTINATION ${CMAKE_INSTALL_PREFIX}/include/)
