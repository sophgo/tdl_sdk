...
static void parse_source_type(TDLViCfg *cfg, const char *value,
...
static void parse_sensor_name(TDLViCfg *cfg, const char *value,
				CVI_U32 param0, CVI_U32 param1, CVI_U32 param2)
{
#define NAME_SIZE 20
	...
	for (i = 0; i < SAMPLE_SNS_TYPE_BUTT; i++) {
		if (strcmp(value, snsr_type_name[i]) == 0) {
			...
			cfg->enWDRMode[index] = (static_cast<TDLSnsType>(i) < SAMPLE_SNS_TYPE_LINEAR_BUTT) ?
...
static void parse_sensor_busid(TDLViCfg *cfg, const char *value,
				CVI_U32 param0, CVI_U32 param1, CVI_U32 param2)
{
	CVI_U32 index = param0;
...
static void parse_sensor_mclk(TDLViCfg *cfg, const char *value,
				CVI_U32 param0, CVI_U32 param1, CVI_U32 param2)
{
	CVI_U32 index = param0;
...
static void parse_sensor_orien(TDLViCfg *cfg, const char *value,
				CVI_U32 param0, CVI_U32 param1, CVI_U32 param2)
{
	CVI_U32 index = param0;
...
typedef CVI_VOID(*parser)(TDLViCfg *cfg, const char *value,
		CVI_U32 param0, CVI_U32 param1, CVI_U32 param2);
